...
train_queries = load('examples/NIPS/Forth/Add/data/train{}_test{}_train.txt'.format(train,test))
test_queries = load('examples/NIPS/Forth/Add/data/train{}_test{}_dev.txt'.format(train,test))

with open('examples/NIPS/Forth/Add/choose.pl') as f:
