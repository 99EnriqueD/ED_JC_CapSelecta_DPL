...
from FashionMNIST.outfit.outfit_baseline.net import Net
...
train_dataset = F_budget(
    ...
    'FashionMNIST/outfit/outfit_baseline/train_budget_base_data.txt')
test_dataset = F_budget(
    torchvision.datasets.FashionMNIST(root='data', train=False, download=True, transform=transform),
    'FashionMNIST/outfit/outfit_baseline/test_budget_base_data.txt')
