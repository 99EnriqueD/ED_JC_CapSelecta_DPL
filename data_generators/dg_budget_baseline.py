...
gather_examples('train', '../FashionMNIST/budget/budget_baseline/train_budget_base_data.txt')
gather_examples('test', '../FashionMNIST/budget/budget_baseline/test_budget_base_data.txt')