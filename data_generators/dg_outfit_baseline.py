...
gather_examples('train', 'FashionMNIST/outfit/outfit_baseline/train_outfit_base_data.txt')
gather_examples('test', 'FashionMNIST/outfit/outfit_baseline/test_outfit_base_data.txt')