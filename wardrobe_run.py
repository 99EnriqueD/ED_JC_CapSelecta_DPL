...
pl_file_path = 'FashionMNIST/wardrobe/appropriate_wardrobe.pl'


train_queries = load('FashionMNIST/wardrobe/train_wardrobe_data.txt')
test_queries = load('FashionMNIST/wardrobe/test_wardrobe_data.txt')
